	...
	<div class="hero-content bg-secondary rounded-lg flex-col lg:flex-row-reverse p-8 shadow-xl">
		...
		<div>
			...
			<p class="py-6 font-semibold">
				...
				in civil engineering. It has grown since then, and today we have four branches of study in the
				polytechnic – Diploma in Civil Engineering, Dip. in Mechanical Engineering, Dip. in Automobile
				engineering and Dip. in Electronics and Telecommunication.
				<br />
				<br />
